...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full h-[75px] transition-all duration-300 ${
        isScrolled ? 'bg-accent-dark shadow-md' : 'bg-transparent'
      }`}
    >
      ...
      >
        ...
        <Link to='/contact' className='m-4 font-medium text-center btn-primary' onClick={() => setIsOpen(false)}>
          Contact
        </Link>
      </div>
    </header>
